...
# Pattern 2: Verbose oscillation — over-explaining after a miss
...
# Pattern 3: Emotional escalation — left the altitude spectrum entirely
# (rarest pattern, most expensive regex — checked last)
