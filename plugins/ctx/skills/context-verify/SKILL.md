...
# /context-verify — Evidence Before Claims
...
Invoke standalone any time you need to verify work, or compose into other skills (e.g., `/context-ship` Phase 3, `/context-execute` final verification).
...
```
/context-ship   → Phase 3 (Verify) invokes this gate
/context-execute → Final verification uses this gate
