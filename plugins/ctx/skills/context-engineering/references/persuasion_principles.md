...
### Liking
**Never use for compliance.** Conflicts with honest feedback culture. Creates sycophancy. This is why context-review-receive bans "Great point!" — liking-based compliance bypasses technical evaluation.
