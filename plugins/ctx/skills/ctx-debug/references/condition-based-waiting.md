...
**Don't use when** testing actual timing behavior (debounce, throttle intervals) — document WHY if using an arbitrary timeout.
...
Requirements: (1) first wait for the triggering condition, (2) timeout based on known timing, not guessing, (3) comment explaining WHY.
