...
- Apply the three gates from `/context-engineering` to the discussion itself: Is the intent clear? Are success criteria emerging? Are we grounded in facts?
...
- For planning: "Want to `/context-plan` this?"
- For quick fixes: "This sounds like normal mode — want me to just do it?"
- For full pipeline: "This is a `/context-ship` candidate."
