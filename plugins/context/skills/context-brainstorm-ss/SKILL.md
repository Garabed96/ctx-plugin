...
# /context-brainstorm-ss — Deep Design Exploration

Same core as `/context-brainstorm` but with fresh-context review and stronger guardrails for complex work. The SS tax is 3-4x tokens — only pay it when the problem warrants it.

## Skill Files

- `SKILL.md` — this file (process, reviewer loop, design principles)
- `references/spec-reviewer-prompt.md` — subagent dispatch template
- Shared with brainstorm: `../context-brainstorm/references/complexity-tags.md`, `../context-brainstorm/references/companion-guide.md`
...
4. **Visual companion** — offer once if upcoming questions are visual (read `../context-brainstorm/references/companion-guide.md`)
...
10. **Tag complexity** — mark each planned unit (see `../context-brainstorm/references/complexity-tags.md`)
...
- **Tag drift**: Complexity tags can be wrong — `/context-execute` should re-classify mid-flight.
