...
# /context-debug — Systematic Root Cause Debugging
...
- If it revealed a design gap, suggest `/context-brainstorm` to design the proper fix
- If it requires multi-step changes, suggest `/context-plan` to break it into tasks
