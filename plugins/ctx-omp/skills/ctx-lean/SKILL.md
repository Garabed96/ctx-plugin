...
4. Route higher-risk, security-sensitive, or multi-system work to `skill://ctx-plan/SKILL.md`; route unresolved product decisions to `skill://ctx-grilling/SKILL.md` or `skill://ctx-prd/SKILL.md`.
