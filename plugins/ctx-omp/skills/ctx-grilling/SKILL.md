---
name: ctx-grilling
description: Relentlessly clarifies a product or implementation idea one recommended decision at a time until its named seams are explicit.
user-invocable: true
---

# ctx-grilling — One decision at a time

Every frontier question goes through `ask`, never a prose questionnaire. The first option is the recommendation and explains why; keep questions short, consequential, and answerable.

1. Start with the desired user outcome and the one decision that most reduces uncertainty. Record answers as durable decisions, assumptions, constraints, or open risks.
