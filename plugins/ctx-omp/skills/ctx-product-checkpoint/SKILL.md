...
5. Use `ask` to gate material product decisions. Record unresolved visual direction as an explicit product decision, then hand it to `skill://ctx-prd/SKILL.md` or `skill://ctx-plan/SKILL.md` as appropriate.
